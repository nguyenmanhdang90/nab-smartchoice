...
@Service
public class TikiPriceServiceImpl implements PriceService {

  private static final List<ProductPrice> MOCK_DATA_FROM_TIKI = IntStream.range(0, 10).boxed()
  ...
  public Optional<ProductPrice> getProductPrice(String productCode) {
    return MOCK_DATA_FROM_TIKI.stream()
